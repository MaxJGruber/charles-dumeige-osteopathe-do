              ...
              <ul role="list">
                <li>
                  <p>
                    ...
                    l'enfant durant la grossesse ou dans les premières semaines
                    de vie. Cette déformation du crâne se caractérise par un
                    aplatissement asymétrique arrière ou latéral de la tête.
                    Dans 75% des cas, cette déformation sera accompagnée d'un
                    torticolis.
                  </p>
                  <p>
                    Ce dernier se caractérise par la tête du bébé tournée du
                    même côté que la plagiocéphalie. Le torticolis peut
                    engendrer des douleurs pour le nourrisson, des difficultés à
                    la position du coucher ou encore des troubles de la succion
                    en cas d'allaitement notamment.
                  </p>
                  <p>
                ...
                <li>
                  ...
                  Considérés comme normaux chez le nourrisson, l'ostéopathie
                  peut aider à diminuer leur fréquence et soulager votre bébé.
                </li>
                <li>
                  <span className="font-semibold">Les coliques:</span> Motifs
                  bénins mais très embêtants pour votre bébé, elles
                  disparaissent avec le temps. Votre ostéopathe va aider tout de
                  même à les soulager et vous donnera des conseils en tant que
                  parent pour l'aider à être soulagé au quotidien.
                </li>
              </ul>
              <p>
                En cas de trouble du sommeil, l'ostéopathie pourra aider votre
                bébé à mieux dormir et avoir un sommeil réparateur en
                travaillant sur ces sphères. Les cas d'otites peuvent être
                également pris en charge.
              </p>
              <p>
                Il est conseillé de consulter votre ostéopathe dans le mois
                après l'accouchement, que ce soit par voie basse ou césarienne
                et quelque soit sa durée. Un suivi pédiatrique est indispensable
                en parallèle.
              </p>
            </div>
          </div>
